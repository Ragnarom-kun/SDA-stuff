...
// * */
//
//            if (pulau.pointer==pulau.head) {
//                pulau.head.height -= X;
//                if (pulau.head.height <= 0) {
//                    pulau.head.height = 1;
//                }
//                res++;
//            } else if (pulau.pointer==pulau.tail) {
//                pulau.tail.height -= X;
//                if (pulau.tail.height <= 0) {
//                    pulau.tail.height = 1;
//                }
//                res++;
//            } else {
//                if (pulau.pointer.height < H) {
//                    pulau.pointer.height -= X;
//                    if (pulau.pointer.height <= 0) {
//                        pulau.pointer.height = 1;
//                    }
//                    res++;
//                }
//            }
