...
//                    murid.setCurrentRank(rank++);               // now = index + 1
...
//                arrNilai = new int[rankingMurid.size()][kelompok];
//                arrStatus = new boolean[rankingMurid.size()][kelompok];
//                // insialisasi awal (krn min 2 org dlm kelompok)
//                arrNilai[0][0] = 0;
//                arrNilai[0][1] = 0;
//                arrStatus[0][0] = true;
//                arrStatus[0][1] = true;
...
//        }
//
//        if (k==0 && index != (arrNilai.length-1)) {     // k==0 tp bukan akhir barisan
//            return 0;
//        }
//
//        if (k==0 && index == (arrNilai.length-1)) {     // k==0 dan akhir barisan
//            return 1;
//        }
//
...
//
//        // recursive case
//        for (int z=1; z < rankingMurid.size(); z++) {
//            String akhirBaru = rankingMurid.get(z).getSpesialisasi();
//            total = total + Deploy(z+1,k-1,akhirBaru);
//        }
//
//        arrNilai[index][k] = total;
//        arrStatus[index][k] = true;
//
//        return total;
//    }
//
