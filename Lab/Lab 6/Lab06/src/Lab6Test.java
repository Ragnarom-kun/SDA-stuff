...
//
//                    //debug
//                    out.println("Cek head : " + dataran.index);
//
//                    // utk update heap
...
//
//                            hashDataran.put(min.value, dataranMin);
//                            hashDataran.put(left.value, dataranKiri);
//                            hashDataran.put(right.value, dataranKanan);
//
//                            // set element
//                            min.value = res;
//                            kiri.value = res;
...
//                            Node kanan = dataranKanan.remove(right);
//                            hashDataran.put(kanan.value, dataranKanan);
//                            kanan.value = res;
//                            kumpulanDataran = hashDataran.get(res);
//                            kumpulanDataran.insert(kanan);
//                            tanah.set(indexRight,kanan);
//                            hashDataran.put(kanan.value, kumpulanDataran);
//                        } else if (res==right.value && res==dataran.value) { // max min dan kanan
//                            Node kiri = dataranKiri.remove(left);
//                            hashDataran.put(kiri.value, dataranKiri);
//                            kiri.value = res;
//                            kumpulanDataran = hashDataran.get(res);
//                            kumpulanDataran.insert(kiri);
//                            tanah.set(indexLeft,kiri);
//                            hashDataran.put(kiri.value, kumpulanDataran);
...
//                            kumpulanDataran.insert(min);
//                            tanah.set(indexMin,min);
//                            hashDataran.put(min.value, kumpulanDataran);
...
//            boolean cek = true;
//            while (cek && temp != null) {
//                if (temp != null && temp.index == dataran.index && temp.next != null) {
//                    temp.next.prev = null;
//                    temp.next = null;
//                    cek = false;
//                }
